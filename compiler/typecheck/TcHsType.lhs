...
module TcHsType (
	...
	tcHsPatSigType, tcPatSig,
                ...
                -- Instantiation with Explicit Types. Needs to be here
                -- otherwise circular module dependencies, instead of TcMType
        tcInstTyVarsETypes
   ) where
...
%************************************************************************
%*									*
		Explicit type application - instantiation
%*									*
%************************************************************************
...
Unfortunately, this needs to be here instead of in TcMType, because the
...
tcInstTyVarsWithApps e@((L _ (ETypeApp (ExplicitTy _ (Just etype)))):etys) (tv:tvs)
  ...
  if (isTypeVar tv) then 
    tcInstTyVarsWithApps (etys) (tvs) (tctyvars, etype:etyORvars, (extendTvSubst subst tv etype), remArgs)
  else
